                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-4">
                                            <img src="{{ asset('gambar/'.$dosen->foto_dosen)}}" width="200" height="400" alt="Gambar">
                                        </div>
                                        <div class="col-sm-4"></div>
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <div class="col-sm-4">
                                        <label for="" class="form-text" style="text-align:left">NIDN</label>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col-sm-4">
                                        <label for="" class="form-text" style="text-align:left">Nama</label>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col-sm-4">
                                        <label for="" class="form-text" style="text-align:left">Alamat</label>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col-sm-4">
                                        <label for="" class="form-text" style="text-align:left">Tanggal Lahir</label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="tgl_lahir" name="tgl_lahir" value="{{ $dosen->tgl_lahir}}">
                                    </div>
                                    @error('judul')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col-sm-4">
                                        <label for="" class="form-text" style="text-align:left">Foto Dosen</label>
                                    </div>
                                    <div class="col-sm-8">
